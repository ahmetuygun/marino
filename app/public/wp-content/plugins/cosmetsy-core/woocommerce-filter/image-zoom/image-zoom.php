<?php
if(get_theme_mod('cosmetsy_single_image_zoom') == 1 || cosmetsy_ft() == 'imgzoom'){
	
/*************************************************
## Scripts
*************************************************/
function cosmetsy_image_zoom_scripts() {
...
add_action( 'wp_enqueue_scripts', 'cosmetsy_image_zoom_scripts' );
...
function cosmetsy_image_zoom_setup() {
	add_theme_support( 'wc-product-gallery-zoom' );
}
add_action( 'after_setup_theme', 'cosmetsy_image_zoom_setup' );
