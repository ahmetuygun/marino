...
## style and scripts  
*************************************************/ 
function cosmetsy_single_sticky_titles_scripts() {
...
add_action( 'wp_enqueue_scripts', 'cosmetsy_single_sticky_titles_scripts' );

/*************************************************
## Single Sticky Titles
*************************************************/ 
add_action('woocommerce_after_single_product','cosmetsy_product_single_sticky_titles');
function cosmetsy_product_single_sticky_titles(){
