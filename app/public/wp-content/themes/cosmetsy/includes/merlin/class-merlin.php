...
class Merlin {
	...
	protected function license() {
        if(cosmetsy_get_registered_purchase_code()) {
	...
	protected function plugins() {
        if(empty(cosmetsy_get_registered_purchase_code())) {
            echo "<p>".esc_html__('Please verify the purchase code first.','cosmetsy')."</p>";
	...
	public function _ajax_activate_license() {
		...
		update_option( 'envato_purchase_code_30886890', $license_key );
