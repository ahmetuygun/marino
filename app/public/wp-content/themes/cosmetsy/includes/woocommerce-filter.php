<?php
/*************************************************
## Cosmetsy Shop View Grid-List
*************************************************/ 
function cosmetsy_shop_view(){
...
## Get Body Class
*************************************************/ 
function cosmetsy_get_body_class( $class ) {
...
if( ! function_exists( 'cosmetsy_is_pjax' ) ) {
	function cosmetsy_is_pjax(){
		if(is_shop() || is_product_category()){
